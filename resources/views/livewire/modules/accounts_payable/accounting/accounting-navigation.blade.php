<div>
    <!-- Side Nav Bar -->
    <aside id="logo-sidebar" class="absolute top-0 left-50 z-0 w-64 h-full pt-0 transition-transform -translate-x-full bg-[#2D349A] border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">   
    ...
    <div class="h-full py-16 px-6 pb-4 overflow-y-auto bg-[#2D349A] dark:bg-gray-800 flex flex-col">
        <ul class="flex flex-col flex-grow space-y-2 font-medium">
            <li>
