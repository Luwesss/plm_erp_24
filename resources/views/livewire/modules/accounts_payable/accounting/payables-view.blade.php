    ...
    <div>
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-8">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap w-full mx-auto">
                            ...
                            <div class="pr-4 mt-3 lg:w-1/3">
                                <div class="relative h-full pt-3 pb-2 text-left">
                                    <div class="mb-6">
                                        <div class="mb-3 text-zinc-950 text-sm font-medium font-['Inter'] leading-tight">BUR Number</div>
                                        <div class="inline-flex items-center justify-start w-full gap-2 px-3 py-2 bg-white border border-gray-200 rounded-md shadow h-9">
                            ...
                            <div class="pr-4 mt-3 lg:w-1/3">
                                <div class="relative h-full pt-3 pb-2 pl-2 text-left rounded-lg">
                                    <div class="mb-6">
                            ...
                            <div class="pr-4 mt-3 lg:w-1/3">
                                <div class="relative h-full pt-3 pb-2 pl-4 text-left rounded-lg">
                                    <div class="mb-6">
                ...
                <div class="w-full pr-3 mb-5 bg-white dark:bg-gray-800 sm:rounded-lg md:mb-0">
                    <!-- Particular and Payable View Section -->
                    <div class="flex flex-wrap mx-auto bg-white dark:bg-gray-800 sm:rounded-lg sm:flex-nowrap">
                        <!-- Particular Section -->
                        ...
                        <div class="flex flex-col mt-8 bg-white rounded-lg lg:w-1/2 md:w-1/2 md:ml-auto md:py-8 md:mt-0" style="align-self: flex-start; margin-top: 0; padding-top: 0;">
