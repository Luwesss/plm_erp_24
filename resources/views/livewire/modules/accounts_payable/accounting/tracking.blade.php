            ...
            <div class="p-4 sm:ml-64">
                <div class="p-4 mt-12">
                    ...
                    <div x-data="dataHandler()">
                        <div class="mb-4 overflow-x-auto border rounded-lg shadow-sm" style="table-layout: fixed;">
                            <table class="w-full text-sm text-left table-auto">
                                <thead class="text-gray-500 font-medium border-b-2 bg-gray-50 border-gray-200 font-['Inter']">
                                    <tr>
                                        <th class="flex items-center px-6 py-3 gap-x-4" style="white-space: nowrap;">
                                            <div>
                                                <input type="checkbox" id="checkbox-all-items" class="hidden checkbox-item peer"
                                        ...
                                        <th class="px-6 py-3" style="white-space: nowrap;">Supplier</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">Particular</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">Amount</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">End-User</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">Current Location</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">Terms of Payment</th>
                                        <th class="px-6 py-3" style="white-space: nowrap;">Remarks</th>
                                    ...
                                    <template x-for="(item, idx) in tableItems" :key="idx">
                                        <tr class="odd:bg-gray-50 even:bg-white">
                                            <td class="px-6 py-4 whitespace-nowrap flex items-center gap-x-4 font-semibold max-w-[180px]">
                                                <div>
                                                    <input type="checkbox" :id="'checkbox-' + idx" :name="'checkbox-' + idx" class="hidden checkbox-item peer"
