    ...
    <div>
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-12">
                ...
                <div class="flex mx-auto space-y-6 max-w-10xl">
                    <!-- Add New Payables Form -->
                    <div class="w-full mb-10 bg-white dark:bg-gray-800 sm:rounded-lg lg:max-w-lg lg:w-1/3 md:w-1/2 md:mb-0">
                            ...
                            <form class="mx-auto mt-5 font-['Inter']">
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="p-1 pl-3 text-red-500">*</span>
                                    </div>
                        ...
                        <div class="pt-5">
                            ...
                            <form class="mx-auto mt-5 font-['Inter']">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="inline-flex items-center justify-start w-full gap-2 px-3 py-2 bg-white border rounded-md border-zinc-200">
                                        <div class="flex items-center justify-start h-6 gap-2 grow shrink basis-0">
                    ...
                    <div class="flex-grow -mb-10 text-center bg-white dark:bg-gray-800 sm:rounded-lg lg:w-1/2 lg:pl-12 lg:text-left" style="align-self: flex-start; margin-top: 0; padding-top: 0;">
