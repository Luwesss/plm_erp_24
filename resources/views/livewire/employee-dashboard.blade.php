        ...
        <div class="p-4 shadow-xl card" style="background-color:rgba(0, 0, 0, 0.10);backdrop-filter: blur(10px)">
            <div class="flex flex-col items-center card-body">
                <div class="flex flex-wrap justify-center gap-4 card-actions">
                    <button class="btn" style="width: 150px; height: 150px">Employee</button>
                    <button class="btn" style="width: 150px; height: 150px">Clinic</button>
                    <button class="btn" style="width: 150px; height: 150px">Library</button>
                    <button class="btn" style="width: 150px; height: 150px">Guidance</button>
                </div>
            </div>
        </div>
    </div>
